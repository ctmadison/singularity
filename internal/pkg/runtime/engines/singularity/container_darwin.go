...
func (c *container) addBindsMount(system *mount.System) error {
	flags := uintptr(0) //syscall.MS_BIND | c.suidFlag | syscall.MS_NODEV | syscall.MS_REC
...
func (c *container) addLibsMount(system *mount.System) error {
	...
	flags := uintptr(0) //syscall.MS_BIND | syscall.MS_NOSUID | syscall.MS_NODEV | syscall.MS_RDONLY | syscall.MS_REC
...
func (c *container) addActionsMount(system *mount.System) error {
	...
	flags := uintptr(0) //syscall.MS_BIND | syscall.MS_RDONLY | syscall.MS_NOSUID | syscall.MS_NODEV
